...
// Configuration constants from Kconfig (idf.py menuconfig)
#define WIFI_SSID      CONFIG_ESP_WIFI_SSID
#define WIFI_PASS      CONFIG_ESP_WIFI_PASSWORD
#define MAXIMUM_RETRY  CONFIG_ESP_MAXIMUM_RETRY

static const char *TAG = "WIFI_UTIL";
int WifiUtil::s_retry_num = 0;

void WifiUtil::event_handler(void* arg, esp_event_base_t event_base,
